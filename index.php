...
// Nhúng các thành phần giao diện hệ thống[cite: 1]
include_once 'public_html/components/header.php';
include_once 'public_html/components/navbar.php';
include_once 'public_html/components/database.php';
...
<div id="homestayCarousel" class="carousel slide carousel-fade shadow" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="5000">
            <img src="public_html/assets/images/banner1.jpg" class="d-block w-100 img-fluid" alt="Không gian Homestay 1" style="height: 500px; object-fit: cover;">
        ...
        <div class="carousel-item" data-bs-interval="5000">
            <img src="public_html/assets/images/banner2.jpg" class="d-block w-100 img-fluid" alt="Không gian Homestay 2" style="height: 500px; object-fit: cover;">
            <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded p-3">
        ...
        <div class="carousel-item" data-bs-interval="5000">
            <img src="public_html/assets/images/banner3.jpg" class="d-block w-100 img-fluid" alt="Không gian Homestay 3" style="height: 500px; object-fit: cover;">
            <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded p-3">
            ...
            while($row = $result->fetch_assoc()) {
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm border-0">
                        <!-- Đường dẫn ảnh tự động nối chuỗi với tên file lưu trong DB[cite: 1] -->
                        <img src="public_html/assets/images/rooms/<?php echo $row['image_name']; ?>" class="card-img-top img-fluid" alt="<?php echo $row['room_name']; ?>" style="height: 230px; object-fit: cover;">
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                ...
                                <a href="public_html/pages/booking.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-sm">Đặt Ngay</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php
// Nhúng phần khung chân giao diện[cite: 1]
include_once 'public_html/components/footer.php';
?>