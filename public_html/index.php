...
<div id="homestayCarousel" class="carousel slide carousel-fade shadow" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="5000">
            <img src="<?php echo $base_url; ?>assets/images/banner1.png" class="d-block w-100 img-fluid" alt="Không gian Homestay 1" style="height: 500px; object-fit: cover;">
        ...
        <div class="carousel-item" data-bs-interval="5000">
            <img src="<?php echo $base_url; ?>assets/images/banner2.png" class="d-block w-100 img-fluid" alt="Không gian Homestay 2" style="height: 500px; object-fit: cover;">
            <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded p-3">
        ...
        <div class="carousel-item" data-bs-interval="5000">
            <img src="<?php echo $base_url; ?>assets/images/banner3.png" class="d-block w-100 img-fluid" alt="Không gian Homestay 3" style="height: 500px; object-fit: cover;">
            <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded p-3">
            ...
            while($row = $result->fetch_assoc()) {
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm border-0">
                        ...
                        <img src="<?php echo $base_url; ?>assets/images/rooms/<?php echo $row['image_name']; ?>" class="card-img-top img-fluid" alt="<?php echo $row['room_name']; ?>" style="height: 230px; object-fit: cover;">
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                ...
                                <a href="<?php echo $base_url; ?>pages/booking.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-sm">Đặt Ngay</a>
                            </div>
                        </div>
                    </div>
                </div>
