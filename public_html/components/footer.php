        ...
        <div class="row g-4">
            <div class="col-12 col-md-4">
                ...
                <div class="d-flex align-items-center mt-3">
                    <img src="<?php echo $base_url; ?>assets/images/logo.png" alt="Logo CozyStay" class="img-fluid bg-light p-2 rounded shadow-sm" style="max-height: 50px;" onerror="this.src='https://placehold.co/150x50?text=Logo+Nhom'">
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                ...
                <ul class="list-unstyled small">
                    ...
                    <li class="mb-2"><a href="<?php echo $base_url; ?>pages/about.php" class="link-light text-white-50 text-decoration-none custom-hover">Giới Thiệu</a></li>
                    <li class="mb-2"><a href="<?php echo $base_url; ?>pages/rooms.php" class="link-light text-white-50 text-decoration-none custom-hover">Phòng Nghỉ</a></li>
                    <li class="mb-2"><a href="<?php echo $base_url; ?>pages/gallery.php" class="link-light text-white-50 text-decoration-none custom-hover">Thư Viện Ảnh</a></li>
                    <li class="mb-2"><a href="<?php echo $base_url; ?>pages/contact.php" class="link-light text-white-50 text-decoration-none custom-hover">Liên Hệ</a></li>
                </ul>
            </div>
